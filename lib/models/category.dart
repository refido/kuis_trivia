...
final List<Category> categories = [
  Category(9, "General Knowledge", icon: FontAwesomeIcons.globe),
  ...
  Category(19, "Maths", icon: FontAwesomeIcons.squareRootVariable),
  Category(20, "Mythology", icon: FontAwesomeIcons.ankh),
  ...
  Category(24, "Politics", icon: FontAwesomeIcons.landmark),
  Category(25, "Art", icon: FontAwesomeIcons.paintbrush),
  Category(26, "Celebrities", icon: FontAwesomeIcons.champagneGlasses),
  Category(27, "Animals", icon: FontAwesomeIcons.dog),
  Category(28, "Vehicles", icon: FontAwesomeIcons.carRear),
  Category(29, "Comics", icon: FontAwesomeIcons.mandalorian),
  Category(30, "Gadgets", icon: FontAwesomeIcons.mobileScreenButton),
  Category(31, "Japanese Anime & Manga", icon: FontAwesomeIcons.earthAsia),
  Category(32, "Cartoon & Animation", icon: FontAwesomeIcons.clapperboard),
];
